...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative flex flex-col items-center justify-start min-h-[100svh] text-center px-4 sm:px-6 pt-28 sm:pt-32 lg:pt-36 pb-20 sm:pb-24 lg:pb-28 overflow-hidden bg-[#030712]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8 sm:mb-10">
          <div className="inline-flex max-w-full items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0f172a] border border-amber-500/30 group cursor-default">
            <div className="w-2 h-2 rounded-full bg-amber-400 animate-ping" />
            <span className="text-xs font-semibold tracking-wider text-amber-400 group-hover:text-amber-300 transition-colors">
              Next-Gen AI Pipeline Active
            </span>
          </div>

          <div className="inline-flex max-w-full items-center gap-2 px-4 py-1.5 rounded-full bg-[#1a0f00] border border-amber-500/40 text-amber-400 shadow-[0_0_20px_rgba(245,158,11,0.15)] group cursor-default">
            <Clock size={13} className="text-amber-400 shrink-0 animate-pulse" />
            <span className="text-xs font-bold tracking-wider text-slate-300">
              24-Hour Ephemeral Storage: <span className="font-medium text-amber-400">Clips auto-delete daily from cloud storage — please download clips you want to keep!</span>
            </span>
          </div>
        </div>
        ...
        <div>
          <h1 className="text-[2.7rem] sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-bold tracking-tighter leading-[0.92] mb-6 sm:mb-8">
            <span className="block text-white drop-shadow-sm">TRANSFORM</span>
            <span className="block">
              <span className="block sm:inline text-amber-400 italic">CONTENT</span>
              <span className="block sm:inline-block sm:ml-4 text-white drop-shadow-sm">TO CLIPS</span>
            </span>
          </h1>
        </div>
        ...
        {/* Subtitle */}
        <div>
          <p className="text-sm sm:text-lg md:text-xl text-slate-300 mb-10 sm:mb-12 max-w-[20rem] sm:max-w-3xl mx-auto leading-relaxed font-normal tracking-normal sm:tracking-wide px-1 sm:px-0">
            Turn long videos into viral short clips in minutes. <br className="hidden md:block" />
            Let AI find your best moments and format them for social media.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-10 px-4 relative z-20">
          ...
          <form
            ...
            className="relative flex items-center p-1.5 rounded-2xl bg-[#030712] border border-white/20 hover:border-white/30 focus-within:border-primary/60 focus-within:hover:border-primary/60 transition-all duration-300 shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
          >
            ...
            <input
              ...
              className="w-full bg-transparent border-none outline-none py-3 px-4 text-xs font-semibold tracking-wider text-white placeholder-slate-400 focus:ring-0"
            />
            <Button
              type="submit"
              suppressHydrationWarning
              className="h-12 px-6 font-bold rounded-xl bg-primary hover:bg-primary/90 text-slate-950 hover:scale-102 active:scale-98 transition-all shrink-0 uppercase tracking-wider text-xs"
            >
              Get Clips
          ...
          {error && (
            <p className="mt-2 text-xs font-bold uppercase tracking-wider text-rose-400 flex items-center gap-1.5 justify-center animate-pulse">
        ...
        <div>
          <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center justify-center gap-4 sm:gap-6 max-w-2xl mx-auto">
            <Magnetic strength={0.1}>
              <Link href="/dashboard">
                <Button className="w-full sm:w-auto h-14 sm:h-16 px-8 sm:px-10 text-base sm:text-lg font-black rounded-2xl bg-primary hover:bg-primary/90 text-slate-950 shadow-2xl shadow-primary/30 animate-glow border border-white/20 group transition-all duration-500 hover:scale-105">
                  Launch Dashboard
            ...
            <Link href="#how-it-works">
              <Button
                variant="outline"
                className="w-full sm:w-auto h-14 sm:h-16 px-8 sm:px-10 text-base sm:text-lg font-bold rounded-2xl border-white/20 bg-slate-900/60 text-white hover:bg-slate-800/80 group transition-all duration-500"
              >
                <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center mr-3 group-hover:bg-primary/30 transition-colors">
        ...
        <div>
          <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-sm sm:max-w-3xl mx-auto">
            {signalStats.map((item) => (
              <div
                key={item.label}
                className="px-4 py-3 rounded-2xl border border-white/15 bg-[#0f172a]"
              >
        ...
        <div>
          <div className="mt-10 sm:mt-12 grid grid-cols-1 lg:grid-cols-[1.3fr_0.9fr] gap-5 sm:gap-6 text-left">
            <div className="rounded-2xl border border-white/15 bg-[#0e1628] p-5 sm:p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                  ...
                  <div className="self-start px-3 py-1 rounded-full border border-emerald-400/30 bg-[#022c1a] text-emerald-300 text-xs font-bold uppercase tracking-wider">
                    Ready
                  </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  {signalFlow.map((item) => (
                    <div key={item.title} className="rounded-2xl border border-white/10 bg-[#070c14] p-5">
            ...
            <div className="rounded-2xl border border-white/15 bg-[#0a1120] p-5 sm:p-6 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-[#070c14] p-4">
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-2">
                      Outcome
                    </p>
        ...
        <div>
          <div className="mt-16 sm:mt-24 lg:mt-28 grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8 text-left">
            {[
              ...
              <div key={i} className="p-6 sm:p-8 rounded-3xl glass-card border-white/10 hover:border-primary/40 group transition-all duration-500">
                ...
                <p className="text-sm text-slate-300 leading-relaxed tracking-wide">{feat.desc}</p>
              </div>
            ))}
          </div>
        </div>
