export function mapDbClipsToResult(clips: any[] = []) {
  return clips
    ...
    .map((clip) => ({
      id: clip.id,
      job_id: clip.job_id,
      video_file: clip.video_url || clip.storage_path,
      video_url: clip.video_url || clip.storage_path,
      thumbnail: clip.thumbnail_url || clip.storage_path,
      thumbnail_file: clip.thumbnail_url || clip.storage_path,
