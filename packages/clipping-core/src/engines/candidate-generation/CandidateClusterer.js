...
exports.CandidateClusterer = void 0;
class CandidateClusterer {
    ...
    clusterCandidates(candidates) {
        ...
        const diverseCandidates = clusters.map(cluster => {
            return cluster.reduce((best, current) => (current.confidence > best.confidence) ? current : best);
        });
...
exports.CandidateClusterer = CandidateClusterer;
