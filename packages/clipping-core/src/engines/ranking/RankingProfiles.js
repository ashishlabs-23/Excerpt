...
exports.RANKING_PROFILES = void 0;
exports.getRankingWeightsForCategory = getRankingWeightsForCategory;
/**
...
exports.RANKING_PROFILES = {
    ...
    reaction: { transcript: 0.20, audio: 0.10, face: 0.30, visual: 0.00, emotion: 0.40 },
 ...
 */
function getRankingWeightsForCategory(category) {
    const profile = exports.RANKING_PROFILES[category] || exports.RANKING_PROFILES.podcast;
